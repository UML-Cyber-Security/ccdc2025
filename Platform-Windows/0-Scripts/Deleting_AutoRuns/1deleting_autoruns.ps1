...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/UML-Cyber-Security/ccdc2025/refs/heads/main/Platform-Windows/0-Scripts/Deleting_AutoRuns/validTaskScheduler1.csv" -OutFile $OutFile
